...
//                입력칸을 비워주자.
    ...
    public void setValues() {
        ...
        messageList.add(new Message("숫자야구를 시작합니다.","COMPUTER"));
        messageList.add(new Message("세자리 숫자를 입력하세요","COMPUTER"));
        messageList.add(new Message("0은 사용하지 않고 중복된 숫자도 사용하지않습니다.","COMPUTER"));
